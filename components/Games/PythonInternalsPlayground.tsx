      ...
      <div className="flex flex-wrap items-center justify-between gap-2 p-2.5 sm:p-3 rounded-2xl bg-card border border-border/50">
        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
          <Button
            ...
            className="bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold text-[11px] sm:text-xs px-2.5 sm:px-3.5 py-1.5 gap-1 sm:gap-1.5 cursor-pointer flex-shrink-0"
          >
