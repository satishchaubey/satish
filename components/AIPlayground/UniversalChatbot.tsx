...
const qaDatabase: { id: number; keywords: string[]; question: string; answer: string }[] = [
  ...
  {
    id: 31,
    keywords: ["resume", "cv", "experience", "timeline", "bio"],
    question: "How can I view Satish's Resume?",
    answer: "You can visit the /resume route to view Satish Chaubey's interactive experience timeline, skills breakdown, and full career history!"
  }
];
